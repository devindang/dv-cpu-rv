...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow -radix unsigned /tb_rv_core/u_rv_core/rf_wr_data
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow -radix unsigned /tb_rv_core/u_rv_core/rf_rd_data2
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow -radix unsigned /tb_rv_core/u_rv_core/alu_result_r
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow -radix unsigned /tb_rv_core/u_rv_core/rf_rd_data2_fw
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow /tb_rv_core/u_rv_core/forward_B
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -color Yellow -itemcolor Yellow /tb_rv_core/u_rv_core/forward_B
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/Group1 -group {Region: sim:/tb_rv_core/u_rv_core} -radix unsigned /tb_rv_core/u_rv_core/rf_rd_data2_fw
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/rd_data1_o
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/rd_data2_o
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/x0
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/x1
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/x2
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_rf/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_rf} -radix unsigned /tb_rv_core/u_rv_core/u_rf/x3
...
add wave -noupdate -expand -label sim:/tb_rv_core/u_rv_core/u_data_mem/u_data_dpram/Group1 -group {Region: sim:/tb_rv_core/u_rv_core/u_data_mem/u_data_dpram} -radix unsigned /tb_rv_core/u_rv_core/u_data_mem/u_data_dpram/dina
